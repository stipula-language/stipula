...
public interface StipulaListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link StipulaParser#event}.
	 * @param ctx the parse tree
	 */
	void enterEvent(StipulaParser.EventContext ctx);
	/**
	 * Exit a parse tree produced by {@link StipulaParser#event}.
	 * @param ctx the parse tree
	 */
	void exitEvent(StipulaParser.EventContext ctx);
	/**
